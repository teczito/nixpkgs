...
stdenvNoCC.mkDerivation (finalAttrs: {
  ...
  src = fetchurl {
    url = "https://dr-download.ti.com/software-development/ide-configuration-compiler-or-debugger/MD-xqxJ05PLfM/${finalAttrs.version}/ti_${finalAttrs.pname}_${finalAttrs.version}_linux-x64_installer.bin";
